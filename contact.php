				...
				<div class="row">
					<div class="col-sm-12">
						...
						<div class="row contact-info-wrap">
							<div class="col-md-3">
								<p><span><i class="icon-location"></i></span> 458 Ton Duc Thang <br> Lien Chieu, Da Nang</p>
							</div>
							<div class="col-md-3">
								...
								<div class="row">
									...
									<div class="col-sm-12">
										<div class="form-group">
											...
											<input type="text" id="subject" class="form-control" placeholder="Nhập vấn đề">
										</div>
									</div>
									<div class="w-100"></div>
									<div class="col-sm-12">
					...
					<div class="col-sm-12 text-center">
						<p>
							<span>
								...
								<script
									type="b891b1986c54a3fa0caa996f-text/javascript">document.write(new Date().getFullYear());</script>
								footwear </span>
						</p>
					</div>
				</div>
